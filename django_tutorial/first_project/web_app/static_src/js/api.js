...
export const getBusinesses = () => Promise.resolve({
	data: [
		{id: 1, position: {lat: 37.779014, lng: -122.419350}, name: 'City Hall', rating: 1},
		{id: 2, position: {lat: 37.795301, lng: -122.393514}, name: 'Ferry Building', rating: 2},
		{id: 3, position: {lat: 37.802480, lng: -122.405801}, name: 'Coit Tower', rating: 3},
	]
})